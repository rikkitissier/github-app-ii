          ...
          <FormUI>
            <RepoSelectorUI>
              <DropList
                ...
                toggler={
                  <SelectTagUI text={selectedRepo?.value || "Select repo..."} />
                }
            ...
            <Input
              value={titleContent}
              onChange={(value: string) => setTitleContent(value)}
              placeholder="Issue title"
            />
            <Input
              multiline={13}
              value={bodyContent}
              onChange={(value: string) => setBodyContent(value)}
              placeholder="Enter some information about this issue"
            />
            <Checkbox
              label="Include original message in issue body"
